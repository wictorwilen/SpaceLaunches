# Space Launches Bot - `spaceLaunchesBot`
...
3. Give the bot a handle (ex: `spaceLaunchesBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://launches.azurewebsites.net/api/messages`
